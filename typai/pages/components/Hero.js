                ...
                <div>
                    <nav className="flex h-9 items-center justify-between" aria-label="Global">
                        ...
                        <div className="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-end">
                            <a
                                href="#"
                                className="inline-block rounded-lg px-3 py-1.5 bg-indigo-500 text-sm font-semibold leading-6 text-white shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20"
                            >
                                Log in
                            </a>
                        </div>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-gray-500/10">
                                    ...
                                    <div className="py-6">
                                        <a
                                            href="#"
                                            className="-mx-3 block rounded-lg py-2.5 px-3 text-center text-base bg-indigo-700 font-semibold leading-6 text-white hover:text-indigo-700 hover:bg-indigo-800/10"
                                        >
                                            Log in
                                        </a>
                                    </div>
                            ...
                            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                                <div className="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
                                    <span className="text-gray-600">
                                        Announcing our beta launch soon.{' '}
